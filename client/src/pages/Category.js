        ...
        {!isCategorySelected && (
          <div className="relative mt-5">
            ...
            <p className="m-8">
              ...
              forming a dynamic community of trendsetters and collectors.
              Embrace the fusion of style, creativity, and individuality as you
              discover and exchange top-tier streetwear from fellow aficionados
              who share your insatiable taste. Step into a world of
              fashion-forward possibilities, where your next statement piece
              awaits. Welcome to the epitome of streetwear exchange.
            </p>
          </div>
        )}
